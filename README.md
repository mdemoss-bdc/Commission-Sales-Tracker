...
2. The rep opens the pushed worksheet. **Your Current Worksheet** (live) sits on top of **Manager / Admin Pushed Worksheet**. Those review tables omit Deal Type. The employee types directly in the bottom table (stock, customer, vehicle, trade, gross, flat, F&I, service) and hits **Confirm Changes & Push Back to Manager**. That submits the corrected bottom table as `pending_manager_approval`. Live records stay frozen until the manager finalizes.
